    ...
    <main className="mx-auto max-w-6xl px-5 pb-24 pt-12 sm:px-8 sm:pt-20 lg:px-10">
      <header className="mb-14 max-w-2xl sm:mb-20">
        ...
        <p className="mt-5 max-w-md text-sm leading-relaxed text-linen-500 sm:text-base">
          Uma coleção de desenhos feitos à mão, explorando detalhes, proporções,
          luzes e sombras para representar pessoas, expressões de forma
          realista. Cada desenho representa dedicação, criatividade e evolução
          artística, transformando simples traços em obras cheias de detalhes e
          personalidade.
        </p>
      </header>
      ...
      <footer className="mt-24 overflow-hidden rounded-xl border border-moss-700/30 bg-ink-900 shadow-[0_20px_45px_-30px_rgba(0,0,0,0.9)]">
              ...
              <span className="flex h-9 w-9 items-center justify-center rounded-full border border-moss-500/50 bg-moss-950 text-moss-300">
                ...
                >
                  <path
                    ...
                    d="M3.5 18.5 9 12l3.5 3.5 2.5-2.5 5.5 5.5M6.5 8.5h.01"
                  />
                  <path strokeLinecap="round" d="M3.5 4.5h17v15h-17z" />
                </svg>
              </span>
              <p className="font-display text-lg italic text-linen-100">
                Galeria DiosArts
              </p>
            </div>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-linen-500">
              Cada traço, um detalhe. Cada desenho, uma história. ✏️

              Obrigado por visitar minha galeria e conhecer um pouco da minha arte.
            </p>
          </div>
        ...
        <div className="flex items-center justify-between gap-4 border-t border-moss-700/30 px-6 py-4 sm:px-9">
          ...
          <nav aria-label="Redes sociais" className="flex items-center gap-2">
            <a
              href="https://wa.me/5598985851353?text=oi%2C%20tudo%20bem%3F%20vim%20da%20galeria%20de%20desenhos"
              target="_blank"
              rel="noreferrer"
              aria-label="WhatsApp"
            ...
            <a
              href="https://www.instagram.com/diobergue/"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://br.pinterest.com/diobergue/desenhos/"
              target="_blank"
              rel="noreferrer"
